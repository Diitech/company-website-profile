...
const blogPosts = [
  {
    ...
    readTime: '8 min read',
    featured: true,
    keywords: ['China sourcing', 'Nigeria import', 'Alibaba suppliers', 'international trade']
  },
  {
    id: 2,
    slug: 'top-digital-skills-2025',
    ...
    readTime: '6 min read',
    featured: false,
    keywords: ['digital skills', 'career growth', 'tech jobs', 'online learning']
  },
  {
    id: 3,
    slug: 'hotel-ota-management-guide',
    ...
    readTime: '5 min read',
    featured: false,
    keywords: ['hotel management', 'OTA optimization', 'Booking.com', 'Airbnb']
  },
  {
    id: 4,
    slug: 'shipping-methods-comparison',
    ...
    readTime: '7 min read',
    featured: false,
    keywords: ['sea freight', 'air freight', 'shipping Nigeria', 'logistics']
  },
  {
    id: 5,
    slug: 'school-enrollment-case-study',
    ...
    readTime: '4 min read',
    featured: false,
    keywords: ['school marketing', 'enrollment growth', 'digital transformation']
  },
  {
    id: 6,
    ...
    readTime: '6 min read',
    featured: false,
    keywords: ['AI automation', 'small business', 'chatbots', 'productivity']
  },
];
...
function BlogIndex() {
  ...
  return (
    <div className="pt-24 pb-16">
      {/* SEO Meta */}
      <title>DMULTICHOICE Blog | Digital Solutions & Import/Export Insights</title>
      <meta name="description" content="Stay updated with industry insights, success stories, import/export guides, and digital transformation tips from DMULTICHOICE Nigeria." />
      <meta name="keywords" content="Nigeria import guide, China sourcing, digital skills, hotel management, logistics Nigeria" />
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold text-white">Our Rankings & Awards</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {rankings.map((ranking, index) => (
              ...
              >
                <Link to={`/awards/${ranking.slug}`}>
                  <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-2xl p-6 border border-yellow-500/20 hover:border-yellow-500/40 transition-all cursor-pointer h-full">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <Link to={`/blog/${featuredPost.slug}`}>
                <div className="bg-glass rounded-3xl overflow-hidden border border-white/10 hover:border-blue-500/30 transition-all">
                  <div className="grid lg:grid-cols-2">
                    ...
                    <div className="p-8 flex flex-col justify-center">
                      ...
                      <h3 className="text-2xl font-bold text-white mb-4 hover:text-blue-400 transition-colors">{featuredPost.title}</h3>
            ...
            {regularPosts.map((post, index) => (
              ...
              >
                <Link to={`/blog/${post.slug}`}>
                  <div className="bg-glass rounded-2xl overflow-hidden border border-white/10 hover:border-blue-500/30 hover:shadow-glow-sm transition-all cursor-pointer h-full">
                    ...
                    <div className="p-5">
                      <h3 className="text-white font-bold mb-2 line-clamp-2 hover:text-blue-400 transition-colors">{post.title}</h3>
